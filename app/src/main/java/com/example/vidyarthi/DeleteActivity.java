...
Button deletebutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rollnumbe=findViewById(R.id.roll);
       ...
       // reff= FirebaseDatabase.getInstance().getReference("personal").child("stu");
        deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                rollnumbe=findViewById(R.id.roll);
                int rollnumber=Integer.parseInt(rollnumbe.getText().toString().trim());
    ...
    private void deletestudent(int rollnumber) {
        DatabaseReference reff = FirebaseDatabase.getInstance().getReference("personal").child(String.valueOf(rollnumber));
        reff.removeValue();
